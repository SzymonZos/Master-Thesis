...
of the thesis are described there. In the chapter \nameref{ch:problem} theory connected to discrete wavelet transform
...
\nameref{ch:subject} is strictly connected to the description of proposed solution and implementation details. There are
